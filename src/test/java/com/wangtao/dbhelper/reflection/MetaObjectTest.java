...
import com.wangtao.dbhelper.domian.blog.Author;
import com.wangtao.dbhelper.domian.blog.Section;
...
public class MetaObjectTest {
    ...
    public void shouldVerifyHasReadablePropertiesReturnedByGetReadablePropertyNames() {
        MetaObject object = MetaObject.forObject(new Author());
    ...
    public void shouldMethodHasGetterReturnTrueWhenListElementSet() {
        ...
        MetaObject meta = MetaObject.forObject(parametersEmulation);
